...
const { FiGrid, FiList, FiPlus, FiTool } = FiIcons;
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Maintain Tasks</h1>
              <p className="text-gray-600">Maintenance and operational tasks</p>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        {[
          { label: 'Total Maintain Tasks', value: tasks.length, color: 'bg-blue-100 text-blue-800' },
